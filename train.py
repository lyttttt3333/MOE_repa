...
os.environ["WANDB_API_KEY"] = "5409d3b960b01b25cec0f6abb5361b4022f0cc41"
    ...
    for epoch in range(args.epochs):
        ...
        for raw_image, x, y in train_dataloader:
            ...
            with accelerator.accumulate(model):
                ...
                loss, proj_loss, l_loss, z_loss = loss_fn(model, x, model_kwargs, zs=zs)
                loss_mean = loss.mean()
                proj_loss_mean = proj_loss.mean()
                loss = loss_mean + proj_loss_mean * args.proj_coeff + l_loss * args.l_loss_coeff + z_loss * args.z_loss_coeff
...
def parse_args(input_args=None):
    ...
    parser.add_argument("--l-loss-coeff", type=float, default=1.0)
    parser.add_argument("--z-loss-coeff", type=float, default=1.0)
